 ...
 * 인터페이스 선언 
  ...
  interface InterfaceName [extends <SuperInterface>,<SupterInterface>....] { // 부모의 인터페이스를 상속 받을 수 있음, 다수의 인터페이스 상속 가능
  		interfaceBody // 추상메서드
  }
 
 예) 인터페이스 정의
  public interface Aquatic {
  		public abstract void swimming(); // public abstract 생략 가능 인터페이스 내에서는 무조건 추상클래스
...
public class D01_interfaceEx1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("rectangle's Area = " + rectangleI.getArea());

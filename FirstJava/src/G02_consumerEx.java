...
public class G02_consumerEx {
	...
	/*
	 * 자바의 표준 API에서 한개의 추상 메서드를 가진 인터페이스들은 모두 람다식으로 사용할 수 있음.
	 * 람다에 사용되는 함수적 인터페이스를 java.util.function 패키지에 설정해서 사용하고 있음.
	 * 	인터페이스 종류 크게 5가지
	...
	public static void main(String[] args) {
		...
		ObjIntConsumer<String> c4 = (lecture, i) -> { // 첫번쨰 타입은 무엇인지 모르겠고 두번쨰 타입은 Int 일때. lecture는 String

...
public class B10_arrayExample2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("1 : " + arr2[1][2]); // 6
		System.out.println("2 : " + arr2[2][1]); // 8
		System.out.println("3 : " + arr2[2][2]); // 9
		System.out.println("4 : " + arr2[3][arr2[3].length - 1]); // 5 -1 이니깐 값이 반전되서 5가 나옴
		System.out.println("int[]의 갯수." + arr2.length); // 4
		...
		System.out.println("5 : " + arr3[0][3][2]); // 3

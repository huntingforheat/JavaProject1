...
public class CustomerManger3 {
		...
		public static void main(String[] args) {
			// 이전에 만들어 놓은 고객고나리 프로그램을 OOP형식으로 변경하여 재 프로그래밍 진행
			// 1. Customer 클래스를 생성하고
			// 2. 관련 프로그램을 위에 생성한 Customer 클래스 기준으로 재작성.
			...
			while (true) { // while문 무한루프
				...
				// 메뉴 선택시 동작을 구현.
				switch (menu.charAt(0)) { // 입력한 문자에서 0번째 인덱스값 불러오기
				case 'ㅑ':
				case 'i':
		...
		public static void inssertCustomerData() { // insert
			...
			/*
			 * // or Customer c1 = new Customer(); c1.setName(name); c1.setGender(gender);
		...
		public static void printCustomerData(Customer cus) { // previous
		...
		public static void updateCustomerData(Customer cus) { // update 불러오는거는 get 설정하는것은 set으로
		...
		public static void deleteCustomerData(Customer cus) { // delete

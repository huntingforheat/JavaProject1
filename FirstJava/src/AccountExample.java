...
public class AccountExample {
	...
	public static void main(String[] args) {
		...
		Account acc1 = new Account("홍길동", "010-1111-2345-109", null, 100000);
...
class Account {
	...
	public Account(String name, String accountNumber, String accountPwd) {
		this.name = name;
	...
	public Account(String name, String accountNumber, String accountPwd, long balance) {
		super();
		this.name = name;
		this.accountNumber = accountNumber;
		this.accountPwd = accountPwd;

...
public class I02_urlEx {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("port : " + url.getPort()); // 주소에 포트번호가 안나와 있으면 -1 출력
			...
			try {
				url = new URL(address);
				URLConnection conn = url.openConnection();	// URLConnection 객체 반환
				...
				System.out.println("getDefaultAllowUserInteraction() : " + conn.getDefaultAllowUserInteraction()); // 기본값 fasle

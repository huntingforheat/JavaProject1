...
public class G09_streamEx2 {
	...
	/*
	 * 	Stream은 BaseStream 인터페이스를 최상위로 Stream(Object), IntStream(int), LongStream(long), DoubleStream(double)을 가지고 있다.
	...
	public static void main(String[] args) {
		...
		// Stream 객체 생성
		isr = str.chars();  // IntStream을 사용한 이유는 char는 정수 계산이 가능하기 때문
		
		isr.forEach(s -> System.out.print((char)s));  // 문자로 출력하기 위해 char로 캐스팅

...
public class F07_bufferedReadWriteEx {
	...
	public static void main(String[] args) {
		...
		String path = "/Users/jungtae/Documents/FileTest/index.html";
		write(path, htmlCode);
		
		System.out.println(read(path));
	}
	
	public static String read(String path) {  // 경로지정 : path 경로를 문자로 받겠다
		// String read(path)

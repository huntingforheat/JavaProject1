...
public class G07_IteratorEx {
	...
	/*
	 * 	스트림 : 여러값들을 가지고 있는 배열이나 콜렉션 등을 for문이 아닌 함수형 인터페이스를 이용해서 반복 처리할 수 있는 기능
	 * 		   자바의 필수 기능은 아니지만 가독성 좋은 코드를 생성하기 위해서 알아둬야 함
	 * 
	...
	public static void main(String[] args) {
		...
		list.stream().forEach(s -> System.out.println(s)); // 배열 스트림

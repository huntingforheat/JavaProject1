...
public class G12_mappingEx {
	...
	/*
	 * 	 매핑(Mapping) : 컬렉션 프레임워크에 Map에 key와 value과 같이 묶어주는 것과 같은 형태로 만들어 주는 개념
	 * 					매핑은 스트림의 데이터를 매개변수로 받아서 가공처리 후 새로운 스트림을 만들어 리턴(데이터 변환을 위한 기능)
	 * 
	...
	public static void main(String[] args) {
		...
		list4.stream().mapToInt(String::length).forEach(len -> System.out.print(len));
		System.out.println();

...
class InstanceInit {
	public final int DATA; // 초기화값을 넣어줘야 함.
 ...
 *    > 형식은 static {} 형태
 *    > 클래스가 로딩 될 떄 딱 한번 만 호출, 생성자 호출되기 전에.
 */
...
public class C06_static_init {
	...
	public static void main(String[] args) {
		// 테스트 확인
		StaticInit s1 = new StaticInit(); // public StaticInit() 1번 실행
		System.out.println(s1);
		StaticInit s2 = new StaticInit(); // public StaticInit() 2번 실행
